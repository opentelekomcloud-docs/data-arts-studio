:original_name: dataartsstudio_01_0359.html

.. _dataartsstudio_01_0359:
...
#. :ref:`Obtaining API Information <dataartsstudio_01_0359__section472213218207>`: Prepare key information of the API.
#. :ref:`Calling an API <dataartsstudio_01_0359__section6697113833611>`: Use Chrome to call the API.
...
.. _dataartsstudio_01_0359__section472213218207:
...
#. Obtain the URL, request method, and input parameters of the API to be called.
   ...
   -  Input parameters: In this example, an API with Query and Path input parameters is created to describe how to enter various input parameters during an API call.
      ...
      .. figure:: /_static/images/en-us_image_0000002269198589.png
...
.. _dataartsstudio_01_0359__section6697113833611:

Calling an API
--------------

#. Start Chrome and create a blank tab.

#. Enter the API calling URL obtained in :ref:`Obtaining API Information <dataartsstudio_01_0359__section472213218207>` in the address box of the browser and access the URL. If input parameters include Path and Query parameters, you need to change the **{path}** variable in the API calling URL to the value of the Path parameter, and add the value of the Query parameter to the end of the API calling URL in the following format: ?\ **Query** **parameter name**\ =\ **Query parameter value**, for example, **?query=1** in this example.
...
#. View the returned result. If **"errCode":"DLM.0"** is returned, the API is successfully called. If the API call fails, rectify the fault based on the error message.


   .. figure:: /_static/images/en-us_image_0000002269118509.png
      :alt: **Figure 2** Using a browser to call an API
