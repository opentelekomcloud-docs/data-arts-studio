:original_name: dataartsstudio_01_0591.html

.. _dataartsstudio_01_0591:

MD5 Verification
================

CDM extracts data from the migration source and writes the data to the migration destination. :ref:`Figure 1 <dataartsstudio_01_0591__en-us_topic_0000001197579313_en-us_topic_0000001151779052_en-us_topic_0108275377_fig4667102414522>` shows the migration mode when files are migrated to OBS.

.. _dataartsstudio_01_0591__en-us_topic_0000001197579313_en-us_topic_0000001151779052_en-us_topic_0108275377_fig4667102414522:

.. figure:: /_static/images/en-us_image_0000002269198113.png
...
.. note::
   ...
   -  If MD5 verification is used, :ref:`KMS encryption <dataartsstudio_01_0590>` cannot be used.
