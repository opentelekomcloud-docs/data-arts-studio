:original_name: dataartsstudio_04_0007.html

.. _dataartsstudio_04_0007:
...
.. _dataartsstudio_04_0007__section545333619504:
...
.. _dataartsstudio_04_0007__section83068019428:
...
#. Click the **Functions** tab and set **Model Design Process**.
   ...
   .. figure:: /_static/images/en-us_image_0000002269111529.png
...
.. _dataartsstudio_04_0007__en-us_topic_0222298525_section21581824122814:

Designing a Subject
-------------------

This section uses the subjects listed in :ref:`Table 1 <dataartsstudio_04_0007__table356815710199>` as an example.
...
.. _dataartsstudio_04_0007__table356815710199:

.. table:: **Table 1** Subject design
...
.. figure:: /_static/images/en-us_image_0000002269191845.png
...
#. Choose **Configuration Center** in the navigation pane on the left. Click the **Subject Processes** tab, and use the default three levels.
   ...
   .. figure:: /_static/images/en-us_image_0000002234232376.png
...
#. On the DataArts Architecture console, choose **Data Survey** > **Subjects** in the left navigation pane. On the page displayed, click **Create** to create an L1 subject, which is a subject area group.
   ...
   .. _dataartsstudio_04_0007__fig184368895516:

   .. figure:: /_static/images/en-us_image_0000002234072240.png
      :alt: **Figure 4** Creating an L1 subject

      **Figure 4** Creating an L1 subject

   In the dialog box displayed, set the parameters as shown in :ref:`Figure 4 <dataartsstudio_04_0007__fig184368895516>` and click **OK**.
...
#. Select the created subject area group and click **publish**. In the **Apply for Publication** dialog box, select a reviewer and click **OK**. Wait for the reviewer to review the application. If you have the reviewer permissions, select **Auto-review** and click **OK**.
   ...
   .. figure:: /_static/images/en-us_image_0000002269191657.png
...
#. Create four L2 subjects under the L1 subject **City transportation**: **Trip records**, **Corporation**, **Time&Space**, and **Public dimensions**.
   ...
   a. Right-click the L1 subject **City transportation** in the subject tree, and select **Create** from the shortcut menu. Alternatively, click **Create** in the right pane.
      ...
      .. figure:: /_static/images/en-us_image_0000002269191577.png
         :alt: **Figure 6** Creating an L2 subject

         **Figure 6** Creating an L2 subject

   b. In the dialog box displayed, set **Subject Name** and **Subject Code** to the values of **Subject Area Name** and **Subject Area Code** in :ref:`Table 1 <dataartsstudio_04_0007__table356815710199>`, set other parameters based on project requirements, and click **OK**.
   ...
   c. Select the created subject area and click **publish**. In the **Apply for Publication** dialog box, select a reviewer and click **OK**. Wait for the reviewer to review the application. If you have the reviewer permissions, select **Auto-review** and click **OK**.
      ...
      .. figure:: /_static/images/en-us_image_0000002269191889.png
...
#. Create business objects.
   ...
   b. In the dialog box displayed, set **Subject Name** and **Subject Code** to the values of **Business Object Name** and **Business Object Code** in :ref:`Table 1 <dataartsstudio_04_0007__table356815710199>`, set other parameters based on project requirements, and click **OK**.
   ...
   c. Select the created business object and click **publish**. In the **Apply for Publication** dialog box, select a reviewer and click **OK**. Wait for the reviewer to review the application. If you have the reviewer permissions, select **Auto-review** and click **OK**.
      ...
      .. figure:: /_static/images/en-us_image_0000002269111637.png
         :alt: **Figure 8** Publishing a business object

         **Figure 8** Publishing a business object

.. _dataartsstudio_04_0007__section142244103311:

Creating and Publishing Lookup Tables
-------------------------------------

This section uses the lookup tables listed in :ref:`Table 2 <dataartsstudio_04_0007__table156812733610>` as an example.

.. _dataartsstudio_04_0007__table156812733610:

.. table:: **Table 2** Lookup tables
...
#. Create three lookup table directories: **payment_type**, **vendor**, and **rate**.
   ...
   a. On the **Lookup Tables** page, click |image1| above the directory tree to create a directory.
      ...
      .. figure:: /_static/images/en-us_image_0000002234232116.png
   ...
   b. In the dialog box displayed, enter a directory name, select a parent directory, and click **OK**.
      ...
      .. figure:: /_static/images/en-us_image_0000002234072272.png
...
#. Create three lookup tables: **payment_type**, **vendor**, and **rate_code**.
   ...
   a. .. _dataartsstudio_04_0007__li16645139502:

      On the **Lookup Tables** page, click **payment_type** in the directory tree, and click **Create** on the page displayed.


      .. figure:: /_static/images/en-us_image_0000002234072576.png
         :alt: **Figure 11** Lookup Tables page

         **Figure 11** Lookup Tables page

   b. .. _dataartsstudio_04_0007__li8669185316506:

      Set the parameters based on :ref:`Table 2 <dataartsstudio_04_0007__table156812733610>` and click **Save**.


      .. figure:: /_static/images/en-us_image_0000002234072328.png
         :alt: **Figure 12** Creating a lookup table

         **Figure 12** Creating a lookup table

   c. Refer to :ref:`3.a <dataartsstudio_04_0007__li16645139502>` to :ref:`3.b <dataartsstudio_04_0007__li8669185316506>` to create the lookup table **vendor** in the **vendor** directory and the lookup table **rate_code** in the **rate** directory.


      .. figure:: /_static/images/en-us_image_0000002269191605.png
         :alt: **Figure 13** Creating a lookup table named vendor

         **Figure 13** Creating a lookup table named vendor


      .. figure:: /_static/images/en-us_image_0000002269111801.png
...
#. Enter values for the three lookup tables **payment_type**, **vendor**, and **rate_code**.
   ...
   On the **Lookup Tables** page, locate the row that contains the lookup table **payment_type**, and choose **More** > **Manage Value** in the **Operation** column. On the page displayed, click **Add** to add the values listed in :ref:`Table 3 <dataartsstudio_04_0007__table16482204445819>`.

   .. _dataartsstudio_04_0007__table16482204445819:

   .. table:: **Table 3** Values to be added for the lookup table payment_type
   ...
   Return to the **Lookup Tables** page, locate the row that contains the lookup table **vendor**, and choose **More** > **Manage Value** in the **Operation** column. On the page displayed, click **Add** to add the values listed in :ref:`Table 4 <dataartsstudio_04_0007__table139471353195913>`.

   .. _dataartsstudio_04_0007__table139471353195913:

   .. table:: **Table 4** Values to be added for the lookup table vendor
   ...
   Return to the **Lookup Tables** page, locate the row that contains the lookup table **rate_code**, and choose **More** > **Manage Value** in the **Operation** column. On the page displayed, click **Add** to add the values listed in :ref:`Table 5 <dataartsstudio_04_0007__table14783193912011>`.

   .. _dataartsstudio_04_0007__table14783193912011:

   .. table:: **Table 5** Values to be added for the lookup table rate_code
...
.. _dataartsstudio_04_0007__section139902116499:

Creating and Publishing Data Standards
--------------------------------------

In this example, you need to create the three data standards listed in :ref:`Table 6 <dataartsstudio_04_0007__table16465343364>`.

.. _dataartsstudio_04_0007__table16465343364:

.. table:: **Table 6** Data standards
...
#. If you access the Data Standards page for the first time, you must customize a template. The custom template can be modified in Configuration Center. Additionally, select **Lookup table**, as shown in the following figure.
   ...
   .. figure:: /_static/images/en-us_image_0000002234072564.png
...
#. Create three directories for data standards: **payment_type**, **vendor**, and **rate_code**.
   ...
   .. figure:: /_static/images/en-us_image_0000002269111545.png
...
.. _dataartsstudio_04_0007__en-us_topic_0222298525_section945153616402:
...
#. On the DataArts Architecture page, choose **Data Warehouse Layer** in the left navigation pane.
   ...
   .. figure:: /_static/images/en-us_image_0000002269191717.png
      :alt: **Figure 20** Creating an SDI model

      **Figure 20** Creating an SDI model


   .. figure:: /_static/images/en-us_image_0000002269191673.png
   ...
   a. Create an SDI ER model named **sdi**. In the **SDI** area, click **Create**. In the displayed **Create Model** dialog box, set the following parameters and click **OK**.
      ...
      .. figure:: /_static/images/en-us_image_0000002234072404.png
   ...
   b. Create a DWI ER model named **dwi**. In the **DWI** area, click **Create**. In the displayed **Create Model** dialog box, set the following parameters and click **OK**.
      ...
      .. figure:: /_static/images/en-us_image_0000002234072456.png
         :alt: **Figure 23** Creating a physical model named dwi

         **Figure 23** Creating a physical model named dwi

#. .. _dataartsstudio_04_0007__en-us_topic_0222298525_li167674202477:
   ...
   .. figure:: /_static/images/en-us_image_0000002234072464.png
   ...
   .. figure:: /_static/images/en-us_image_0000002234232060.png
   ...
   .. figure:: /_static/images/en-us_image_0000002269191549.png
...
#. Create a standard business table to record trip data.
   ...
   b. On the **Basic Settings** tab page, set the parameters as shown in the figure below.
      ...
      .. table:: **Table 7** Standard trip data table
      ...
      .. figure:: /_static/images/en-us_image_0000002234072472.png
   ...
   c. Click **Next** to go to the **Table Fields** page. Click **Add**. Add the fields listed in :ref:`Table 8 <dataartsstudio_04_0007__table929218193298>`. Then click |image3| in the **Data Standard** column of the rows where the vendor ID, rate code ID, and payment type reside to associate with the **Vendor**, **Rate Code ID**, and **Payment Type** standards, respectively. :ref:`Figure 28 <dataartsstudio_04_0007__en-us_topic_0222298525_fig1948138204112>` shows the configuration after the fields are added.

      .. _dataartsstudio_04_0007__table929218193298:

      .. table:: **Table 8** Fields to be added to the table named dwi_table_trip_data
      ...
      .. _dataartsstudio_04_0007__en-us_topic_0222298525_fig1948138204112:

      .. figure:: /_static/images/en-us_image_0000002234072440.png
   ...
   e. Click **Next** to go to the **Mappings** page and create mappings to design data sources of the table.
      ...
      In this example, you only need to create one mapping. Click **Create** and set a mapping as shown in :ref:`Figure 29 <dataartsstudio_04_0007__en-us_topic_0222298525_fig2672153020255>`.
      ...
      -  Select the source table **sdi_taxi_trip_data** for **Table**. All data in the **dwi_taxi_trip_data** table comes from this source table.
         ...
         .. _dataartsstudio_04_0007__en-us_topic_0222298525_fig2672153020255:

         .. figure:: /_static/images/en-us_image_0000002269111825.png
      ...
      -  **Field Mapping**
         ...
         In the **Field Mapping** area, set source fields for the fields in the table in sequence. The selected source fields must have the same meaning as the fields in the table. As shown in :ref:`Figure 30 <dataartsstudio_04_0007__en-us_topic_0222298525_fig1344103811414>`, an SQL statement is displayed at the bottom of **Field Mapping** for reference.
         ...
         .. _dataartsstudio_04_0007__en-us_topic_0222298525_fig1344103811414:

         .. figure:: /_static/images/en-us_image_0000002234072344.png
...
#. Select the created model and choose **More** > **Export**. In the dialog box displayed, select **Table** for **Export** and click **OK**. Export the **sdi** model in the same way. You can use the exported model as a backup and import it.
   ...
   .. figure:: /_static/images/en-us_image_0000002234232384.png
...
#. Publish the table model.
   ...
   a. Publish the source table imported to the SDI ER model in :ref:`2 <dataartsstudio_04_0007__en-us_topic_0222298525_li167674202477>`. After the table is published, you can use DataArts Studio to manage and monitor the source table.
...
#. After the application is approved, you can view **Status** and **Sync Status** of the corresponding model on the **ER Modeling** page.
   ...
   .. figure:: /_static/images/en-us_image_0000002269111433.png
   ...
   .. figure:: /_static/images/en-us_image_0000002269191589.png
      :alt: **Figure 33** Table details

      **Figure 33** Table details

.. _dataartsstudio_04_0007__section265510426117:
...
#. Create the three lookup table dimensions listed in :ref:`Table 9 <dataartsstudio_04_0007__table1988313451106>`.

   .. _dataartsstudio_04_0007__table1988313451106:

   .. table:: **Table 9** Lookup table dimensions
   ...
   a. Click the **Dimensions** tab, choose **City transportation** > **Corporation** > **Suppliers** in the subject tree, and click **Create** to create a dimension named **dim_vendor**.
      ...
      .. figure:: /_static/images/en-us_image_0000002269111577.png
   ...
   b. On the **Create Dimension** page, set the parameters as shown in the figure below and click **Save**.
      ...
      .. figure:: /_static/images/en-us_image_0000002269111417.png
   ...
   c. Click the **Dimensions** tab, choose **City transportation** > **Public dimensions** > **Public dimensions** in the subject tree, and click **Create** to create a dimension named **dim_rate_code**. On the **Create Dimension** page, set the parameters as shown in the figure below and click **Save**.
      ...
      .. figure:: /_static/images/en-us_image_0000002234072604.png
   ...
   d. Click the **Dimensions** tab, choose **City transportation** > **Public dimensions** > **Public dimensions** in the subject tree, and click **Create** to create a dimension named **dim_payment_type**. On the **Create Dimension** page, set the parameters as shown in the figure below and click **Save**.
      ...
      .. figure:: /_static/images/en-us_image_0000002234072300.png
...
#. Create a hierarchy dimension named **dim_date**.
   ...
   b. Configure the basic settings and physicalization settings as shown in the figure below.
      ...
      .. figure:: /_static/images/en-us_image_0000002234232076.png
   ...
   c. In the **Field Settings** area, add fields as described in the table below.
      ...
      .. figure:: /_static/images/en-us_image_0000002234232204.png
   ...
   d. In the **Hierarchy Settings** area, click **Add** to create two layers as shown in the figures below.
      ...
      .. figure:: /_static/images/en-us_image_0000002269111689.png
         :alt: **Figure 40** Layer 1

         **Figure 40** Layer 1


      .. figure:: /_static/images/en-us_image_0000002269191785.png
...
#. After a dimension is published and approved, the system automatically creates a dimension table for the dimension. The name and code of the dimension table are the same as those of the dimension. On the **Dimensional Modeling** page, click the **Dimension Tables** tab to view the created dimension table.
   ...
   .. figure:: /_static/images/en-us_image_0000002234232148.png
      :alt: **Figure 42** Sync Status of the dimension tables

      **Figure 42** Sync Status of the dimension tables

.. _dataartsstudio_04_0007__section665784223319:
...
#. Click the **Fact Tables** tab, choose **City transportation** > **Trip records** > **Trip facts** in the subject tree, and click **Create** to create a fact table named **stroke_order**.
   ...
   In the **Field Settings** area, choose **Create** > **Dimension**. In the dialog box displayed, select the dimensions **rate_code**, **vendor**, **payment_type**, and **date**, and click **OK**. Choose **Create** > **Dimension**. In the dialog box displayed, select the dimension **date** and click **OK**. In the dimension field list, adjust the sequence of the dimension fields and modify the information about the two **date** dimensions, as listed in :ref:`Table 12 <dataartsstudio_04_0007__table16541810165218>`.

   .. _dataartsstudio_04_0007__table16541810165218:

   .. table:: **Table 12** Dimension fields
   ...
   In the **Field Settings** area, choose **Create** > **Measure** and create the fields listed in :ref:`Table 13 <dataartsstudio_04_0007__table751725421110>` in sequence.

   .. _dataartsstudio_04_0007__table751725421110:

   .. table:: **Table 13** Measure fields
   ...
   .. figure:: /_static/images/en-us_image_0000002269111789.png
...
.. _dataartsstudio_04_0007__section1222433193512:

Creating and Publishing Technical Metrics
-----------------------------------------

In this example, you need to create the technical metrics listed in :ref:`Table 14 <dataartsstudio_04_0007__table19618548718>` and :ref:`Table 15 <dataartsstudio_04_0007__table56617262116>`.

.. _dataartsstudio_04_0007__table19618548718:

.. table:: **Table 14** Atomic metrics
...
.. _dataartsstudio_04_0007__table56617262116:

.. table:: **Table 15** Derivative metrics
...
#. Create an atomic metric named **total_amount** to collect statistics on fares.
   ...
   b. On the **Create Atomic Metric** page, set the parameters as shown in the figure below and click **Publish**.
      ...
      .. figure:: /_static/images/en-us_image_0000002269191609.png
...
#. Create three derivative metrics.
   ...
   -  Create **total_amount_(payment_type)** to collect statistics on the total fares based on **payment_type**.
      ...
      .. figure:: /_static/images/en-us_image_0000002269111481.png
   ...
   -  Create **total_amount_(rate_code)** to collect statistics on the total fares based on **rate_code**.
      ...
      .. figure:: /_static/images/en-us_image_0000002234232464.png
   ...
   -  Create **total_amount_(vendor,stroke_order.dim_dropoff_date_key)** to collect statistics on the total fares based on **vendor**.
      ...
      .. figure:: /_static/images/en-us_image_0000002269191877.png
...
.. _dataartsstudio_04_0007__section829585916339:

Data Mart: Creating and Publishing Summary Tables for the DM Layer
------------------------------------------------------------------

Create the three summary tables listed in :ref:`Table 16 <dataartsstudio_04_0007__table219762715358>` for the DM layer.

.. _dataartsstudio_04_0007__table219762715358:

.. table:: **Table 16** Summary tables
...
#. Create three summary tables: **payment_type**, **rate_code**, and **vendor**.
   ...
   a. On the **Summary Tables** page, choose **City transportation** > **Trip records** > **Record statistics** in the directory tree, and click **Create** to create a summary table named **dws_payment_type**. On the **Create Summary Table** page, set the parameters and click **Save**.
      ...
      .. figure:: /_static/images/en-us_image_0000002269191833.png
      ...
      .. figure:: /_static/images/en-us_image_0000002234232132.png
      ...
      .. figure:: /_static/images/en-us_image_0000002269191925.png
   ...
   b. On the **Summary Tables** page, choose **City transportation** > **Trip records** > **Record statistics** in the directory tree, and click **Create** to create a summary table named **dws_rate_code**. On the **Create Summary Table** page, set the parameters and click **Save**.
      ...
      .. figure:: /_static/images/en-us_image_0000002269111441.png
      ...
      .. figure:: /_static/images/en-us_image_0000002269191821.png
   ...
   c. On the **Summary Tables** page, choose **City transportation** > **Trip records** > **Record statistics** in the directory tree, and click **Create** to create a summary table named **dws_vendor**. On the **Create Summary Table** page, set the parameters and click **Save**.
      ...
      .. figure:: /_static/images/en-us_image_0000002234072232.png
      ...
      .. figure:: /_static/images/en-us_image_0000002234072400.png
...
#. Log in to the DataArts Studio console as a reviewer. Locate the created DataArts Studio instance and click **Access**. In the workspace list, locate the target workspace and click **DataArts Architecture**.
#. Choose **Metrics** > **Review Center** in the left navigation pane, click the **Pending Review** tab, select the objects to be reviewed in the list, and click **Review** above the list.
#. Enter review comments and click **Accept**.

.. |image1| image:: /_static/images/en-us_image_0000002234232452.png
.. |image2| image:: /_static/images/en-us_image_0000002234072548.png
.. |image3| image:: /_static/images/en-us_image_0000002234232276.png
.. |image4| image:: /_static/images/en-us_image_0000002234232252.png
.. |image5| image:: /_static/images/en-us_image_0000002269191701.png
.. |image6| image:: /_static/images/en-us_image_0000002234232216.png
.. |image7| image:: /_static/images/en-us_image_0000002269111817.png
