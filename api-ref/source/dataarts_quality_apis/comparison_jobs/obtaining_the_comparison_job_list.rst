:original_name: ListConsistencyTask.html

.. _ListConsistencyTask:
...
.. table:: **Table 4** Response body parameters
   ...
   +-----------+---------------------------------------------------------------------------------------------------------+-------------------------+
   | resources | Array of :ref:`QualityTaskOverviewVO_2 <listconsistencytask__response_qualitytaskoverviewvo_2>` objects | Pagination data         |
   +-----------+---------------------------------------------------------------------------------------------------------+-------------------------+

.. _listconsistencytask__response_qualitytaskoverviewvo_2:

.. table:: **Table 5** QualityTaskOverviewVO_2
