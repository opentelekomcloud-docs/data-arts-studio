:original_name: BatchDeleteQualityQualityTasks.html

.. _BatchDeleteQualityQualityTasks:
...
.. table:: **Table 3** Request body parameters
   ...
   | Parameter | Mandatory | Type              | Description                           |
   +===========+===========+===================+=======================================+
   | [items]   | Yes       | Array of integers | IDs of the quality jobs to be deleted |
   +-----------+-----------+-------------------+---------------------------------------+
...
.. code-block:: text
   ...
   POST https://{endpoint}/v2/{project_id}/quality/quality-tasks/batch-delete
