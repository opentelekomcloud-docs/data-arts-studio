...
-  Parameter description
   ...
   +------------+-----------+---------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | version    | No        | Integer | Job version number. If this parameter is specified, jobs of the specified version are queried. If this parameter is not specified, jobs of the latest version are queried. |
   +------------+-----------+---------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
.. table:: **Table 2** Parameters
   ...
   +-------------------+-----------------+----------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | createTime        | No              | Long                       | Job creation time                                                                                                                                                                                 |
   +-------------------+-----------------+----------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | downstreamJobs    | No              | String                     | Name of the downstream job that depends on the current job                                                                                                                                        |
   +-------------------+-----------------+----------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   ...
   +-------------------+-----------------+----------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | description       | No              | String                     | Job description                                                                                                                                                                                   |
   +-------------------+-----------------+----------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | cleanoverdueDays  | No              | integer                    | Maximum timeout duration of the job                                                                                                                                                               |
   +-------------------+-----------------+----------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | cleanWaitingJob   | No              | String                     | Whether to clear waiting jobs                                                                                                                                                                     |
   +-------------------+-----------------+----------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | emptyRunningJob   | No              | String                     | Whether to enable dry run                                                                                                                                                                         |
   +-------------------+-----------------+----------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | version           | No              | String                     | Job version                                                                                                                                                                                       |
   +-------------------+-----------------+----------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | singleNodeJobFlag | No              | Boolean                    | Whether the job is a single-task job. The default value is **false**.                                                                                                                             |
   +-------------------+-----------------+----------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | singleNodeJobType | No              | String                     | Single-task job type. If the job type is **BATCH**, the following values are available for this parameter:                                                                                        |
   |                   |                 |                            |                                                                                                                                                                                                   |
   |                   |                 |                            | -  DLISQL                                                                                                                                                                                         |
   |                   |                 |                            | -  DWSSQL                                                                                                                                                                                         |
   |                   |                 |                            | -  HiveSQL                                                                                                                                                                                        |
   ...
   |                   |                 |                            | -  RDSSQL                                                                                                                                                                                         |
   |                   |                 |                            |                                                                                                                                                                                                   |
   |                   |                 |                            | If the job type is **REAL_TIME**, the value of this parameter can be **FlinkSQL**, **DLISpark**, or **FlinkJar**.                                                                                 |
   +-------------------+-----------------+----------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
.. table:: **Table 8** CronTrigger data structure description
   ...
   |                    |                 |                          | Default value: false                                                                                                                                                                                                                                                                                                      |
   +--------------------+-----------------+--------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | dependJob          | No              | DependJob data structure | Dependent job configuration. For details, see :ref:`Table 12 DependJob data structure description <dataartsstudio_02_0087__en-us_topic_0181281297_table10750194763920>`.                                                                                                                                                  |
   +--------------------+-----------------+--------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
.. table:: **Table 9** Cron data structure description
   ...
   |                    |                 |                          | Default value: false                                                                                                                                                                                                                                                                                                      |
   +--------------------+-----------------+--------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | dependJobs         | No              | DependJob data structure | Dependent job configuration. For details, see :ref:`Table 12 DependJob data structure description <dataartsstudio_02_0087__en-us_topic_0181281297_table10750194763920>`.                                                                                                                                                  |
   +--------------------+-----------------+--------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | intervalType       | No              | String                   | Scheduling interval type. The following options are available:                                                                                                                                                                                                                                                            |
   |                    |                 |                          |                                                                                                                                                                                                                                                                                                                           |
   |                    |                 |                          | -  **minutes**                                                                                                                                                                                                                                                                                                            |
   |                    |                 |                          | -  **hours**                                                                                                                                                                                                                                                                                                              |
   |                    |                 |                          | -  **days**                                                                                                                                                                                                                                                                                                               |
...
.. table:: **Table 12** DependJob data structure description
   ...
   |                    |                 |                                   | Default value: **FAIL**                                                                                                        |
   +--------------------+-----------------+-----------------------------------+--------------------------------------------------------------------------------------------------------------------------------+
   | sameWorkSpaceJobs  | No              | DependWorkspaceJob data structure | List of dependent jobs in the current workspace. For details, see :ref:`Table 30 <dataartsstudio_02_0087__table672662142419>`. |
   +--------------------+-----------------+-----------------------------------+--------------------------------------------------------------------------------------------------------------------------------+
   | otherWorkSpaceJobs | No              | DependWorkspaceJob data structure | List of dependent jobs in other workspaces. For details, see :ref:`Table 30 <dataartsstudio_02_0087__table672662142419>`.      |
   +--------------------+-----------------+-----------------------------------+--------------------------------------------------------------------------------------------------------------------------------+
...
.. table:: **Table 27** BasicConfig job information
   ...
   +-----------------+-----------+--------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | isIgnoreWaiting | No        | integer            | Whether to exclude waiting time from the instance timeout duration. The value can be **0** or **1**. **0** indicates that the waiting time is not excluded from the instance timeout duration, and **1** indicates that the waiting time is excluded from the instance timeout duration |
   +-----------------+-----------+--------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
.. _dataartsstudio_02_0087__table672662142419:

.. table:: **Table 30** DependWorkSpaceJob data structure description
   ...
   | jobName                  | Yes       | String  | Job name                                                    |
   +--------------------------+-----------+---------+-------------------------------------------------------------+
   | dependOnLastPeriod       | No        | Boolean | Whether to depend on the latest instance of an upstream job |
   +--------------------------+-----------+---------+-------------------------------------------------------------+
   | dependType               | No        | String  | Dependency rule                                             |
   +--------------------------+-----------+---------+-------------------------------------------------------------+
   | dependOnLastNPeriodValue | No        | Integer | Number of previous periods on which the job depends         |
   +--------------------------+-----------+---------+-------------------------------------------------------------+
...
.. note::
   ...
   If **dependencies=true** is contained in the parameters for calling the API used to query job details, the downstream jobs (first layer) that depend on the current job are returned.

   .. code-block:: text

      GET /v1/b384b9e9ab9b4ee8994c8633aabc9505/jobs/xxx_1?dependencies=true
      xxx_1 indicates the job name.
      The response message returns the downstream jobs that depends on the current job, as shown in the downstreamJobs field in the following example response message:
