...
-  Parameter description
   ...
   .. table:: **Table 1** URI parameters
      ...
      +-----------------+-----------------+-----------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
      | minPlanTime     | No              | Long            | Minimum planned job execution time accurate to millisecond. Job instances whose start time is later than this time are returned. The default value is 00:00:00 of the current day.                                                                           |
      +-----------------+-----------------+-----------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
      | maxPlanTime     | No              | Long            | Maximum planned job execution time accurate to millisecond. Job instances whose start time is earlier than this time are returned. The default value is the current time point. The time range between the start time and end time cannot exceed three days. |
      +-----------------+-----------------+-----------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
