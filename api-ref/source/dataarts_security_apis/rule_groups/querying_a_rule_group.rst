:original_name: ShowSecurityDataClassificationRuleGroup.html

.. _ShowSecurityDataClassificationRuleGroup:
...
GET /v1/{project_id}/security/data-classification/rule/group/{id}
...
.. table:: **Table 1** Path Parameters
   ...
   +------------+-----------+--------+-------------------------------------------------------------------------------------------------------------------------+
   | id         | Yes       | String | ID of the rule group to be queried.                                                                                     |
   +------------+-----------+--------+-------------------------------------------------------------------------------------------------------------------------+
...
.. table:: **Table 3** Response body parameters
   ...
   +-------------+-------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------+
   | rules       | Array of :ref:`DataClassificationRuleQueryDTO <showsecuritydataclassificationrulegroup__response_dataclassificationrulequerydto>` objects | Rule entity.                       |
   +-------------+-------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------+
...
.. _showsecuritydataclassificationrulegroup__response_dataclassificationrulequerydto:

.. table:: **Table 4** DataClassificationRuleQueryDTO
...
.. code-block::
   ...
   v1/0833a5737480d53b2f25c010dc1a7b88/security/data-classification/rule/group/ped96c90125691b8bf8d6886407b816t
