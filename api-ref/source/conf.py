...
project = 'DataArts Studio'
otcdocs_repo_name = 'opentelekomcloud-docs/data-arts-studio'
# Those variables are required for edit/bug links

# Those variables are needed for indexing into OpenSearch
otcdocs_doc_environment = 'public'
otcdocs_doc_link = '/data-arts-studio/api-ref/'
otcdocs_doc_title = 'API Reference'
otcdocs_doc_type = 'api-ref'
otcdocs_service_category = 'big_data'
otcdocs_service_title = 'DataArts Studio'
otcdocs_service_type = 'dataarts_studio'
...
html_title = "DataArts Studio - API Reference"
...
latex_documents = [
    ('index',
     'dataarts_studio-api-ref.tex',
     u'DataArts Studio - API Reference',
