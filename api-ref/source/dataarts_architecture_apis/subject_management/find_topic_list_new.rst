:original_name: SearchSubjectNew.html
...
GET /v3/{project_id}/design/subjects
...
.. table:: **Table 4** Response body parameters
   ...
   +===========+======================================================+================================================================+
   | data      | :ref:`data <searchsubjectnew__response_data>` object | data: unified outermost data structure of the returned result. |
   +-----------+------------------------------------------------------+----------------------------------------------------------------+

.. _searchsubjectnew__response_data:
...
.. table:: **Table 5** data
   ...
   | Parameter | Type                                                   | Description                                                 |
   +===========+========================================================+=============================================================+
   | value     | :ref:`value <searchsubjectnew__response_value>` object | value: unified outer data structure of the returned result. |
   +-----------+--------------------------------------------------------+-------------------------------------------------------------+

.. _searchsubjectnew__response_value:
...
.. table:: **Table 6** value
   ...
   +-----------+--------------------------------------------------------------------------+------------------------+
   | records   | Array of :ref:`CatalogVO <searchsubjectnew__response_catalogvo>` objects | CatalogVO information. |
   +-----------+--------------------------------------------------------------------------+------------------------+

.. _searchsubjectnew__response_catalogvo:
...
.. table:: **Table 7** CatalogVO
   ...
   |                       |                                                                                            | -  REJECT: rejected                                                                                                                                                           |
   +-----------------------+--------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | new_biz               | :ref:`BizVersionManageVO <searchsubjectnew__response_bizversionmanagevo>` object           | Service version management. This parameter is read-only.                                                                                                                      |
   +-----------------------+--------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   ...
   +-----------------------+--------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | children              | Array of :ref:`CatalogVO <searchsubjectnew__response_catalogvo>` objects                   | Lower-level subdirectory, which is read-only.                                                                                                                                 |
   +-----------------------+--------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | self_defined_fields   | Array of :ref:`SelfDefinedFieldVO <searchsubjectnew__response_selfdefinedfieldvo>` objects | Customize Attribute Field:                                                                                                                                                    |
   +-----------------------+--------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+

.. _searchsubjectnew__response_bizversionmanagevo:
...
.. _searchsubjectnew__response_selfdefinedfieldvo:
...
.. code-block:: text
   ...
   GET https://{endpoint}/v2/{project_id}/design/subjects?parent_id=-1
     ...
     "data" : {
       "value" : {
         ...
         "records" : [ {
           ...
           "name_en" : "test_import",
           "description" : null,
           "qualified_name" : "test_import@Business.0833a5737480d53b2f25c010dc1a7b88-workspace-9ce2cfd08fda4f3b95faa5ba65fa5ec3",
           ...
           "create_by" : "test_uesr",
           "update_by" : "test_uesr",
           "create_time" : "2024-01-06T10:44:07+08:00",
           "update_time" : "2024-01-26T11:16:24+08:00",
           "self_defined_fields" : [ ],
           "children_num" : null,
           "children" : null
         } ]
