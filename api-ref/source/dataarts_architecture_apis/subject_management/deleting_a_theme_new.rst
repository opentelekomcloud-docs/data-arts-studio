:original_name: DeleteSubjectNew.html
...
DELETE /v3/{project_id}/design/subjects
...
.. table:: **Table 4** Response body parameters
   ...
   +===========+======================================================+====================================================================================================+
   | data      | :ref:`data <deletesubjectnew__response_data>` object | Indicates the final deletion result, that is, the number of objects that are successfully deleted. |
   +-----------+------------------------------------------------------+----------------------------------------------------------------------------------------------------+

.. _deletesubjectnew__response_data:
