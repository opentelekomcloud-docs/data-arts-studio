:original_name: RemoveDesignEntityTags.html

.. _RemoveDesignEntityTags:
...
.. table:: **Table 4** Response body parameters
   ...
   +===========+============================================================+============================+
   | data      | :ref:`data <removedesignentitytags__response_data>` object | Returned data information. |
   +-----------+------------------------------------------------------------+----------------------------+

.. _removedesignentitytags__response_data:
