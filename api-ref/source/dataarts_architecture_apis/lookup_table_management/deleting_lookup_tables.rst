:original_name: DeleteCodeTable.html
...
DELETE /v2/{project_id}/design/code-tables
...
.. table:: **Table 4** Response body parameters
   ...
   +===========+=====================================================+====================================================================================================+
   | data      | :ref:`data <deletecodetable__response_data>` object | Indicates the final deletion result, that is, the number of objects that are successfully deleted. |
   +-----------+-----------------------------------------------------+----------------------------------------------------------------------------------------------------+

.. _deletecodetable__response_data:
...
This API is used to delete a lookup table based on the request parameters. The number of lookup tables that are successfully deleted is returned.

.. code-block:: text

   DELETE https://{endpoint}/v2/{project_id}/design/code-tables

   {
     "ids" : [ "1230206616507449344", "1230206580511875072" ]
   }
