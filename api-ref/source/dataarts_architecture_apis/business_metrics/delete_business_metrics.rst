:original_name: DeleteBizMetric.html
...
DELETE /v2/{project_id}/design/biz-metrics
...
.. table:: **Table 4** Response body parameters
   ...
   +===========+=====================================================+====================================================================================================+
   | data      | :ref:`data <deletebizmetric__response_data>` object | Indicates the final deletion result, that is, the number of objects that are successfully deleted. |
   +-----------+-----------------------------------------------------+----------------------------------------------------------------------------------------------------+

.. _deletebizmetric__response_data:
...
This API is used to delete a service indicator based on the row service indicator ID.

.. code-block:: text

   DELETE https://{endpoint}/v2/{project_id}/design/biz-metrics

   {
     "ids" : [ "1231252097002024960" ]
   }
