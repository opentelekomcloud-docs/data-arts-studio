:original_name: ListBizMetricOwners.html

.. _ListBizMetricOwners:
...
View the metric owner information.
...
GET /v2/{project_id}/design/biz-metrics/owners
...
View the business metric owner set.

.. code-block:: text

   GET https://{endpoint}/v2/{project_id}/design/biz-metrics/owners
...
This operation succeeds, and the returned data is an array of metric owner names.
...
+=============+===================================================================================+
| 200         | This operation succeeds, and the returned data is an array of metric owner names. |
+-------------+-----------------------------------------------------------------------------------+
| 400         | BadRequest                                                                        |
+-------------+-----------------------------------------------------------------------------------+
| 401         | Unauthorized                                                                      |
