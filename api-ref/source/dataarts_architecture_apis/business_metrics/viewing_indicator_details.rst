:original_name: ShowBizMetricById.html
...
This API is used to view indicator details by ID.
...
GET /v2/{project_id}/design/biz-metrics/{id}
...
.. table:: **Table 4** Response body parameters
   ...
   +===========+=======================================================+================================================================+
   | data      | :ref:`data <showbizmetricbyid__response_data>` object | data: unified outermost data structure of the returned result. |
   +-----------+-------------------------------------------------------+----------------------------------------------------------------+

.. _showbizmetricbyid__response_data:
...
.. table:: **Table 5** data
   ...
   | Parameter | Type                                                                | Description                                                 |
   +===========+=====================================================================+=============================================================+
   | value     | :ref:`BizMetricVO <showbizmetricbyid__response_bizmetricvo>` object | value: unified outer data structure of the returned result. |
   +-----------+---------------------------------------------------------------------+-------------------------------------------------------------+

.. _showbizmetricbyid__response_bizmetricvo:

.. table:: **Table 6** BizMetricVO
   ...
   +-----------------------+---------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | approval_info         | :ref:`ApprovalVO <showbizmetricbyid__response_approvalvo>` object                           | Approval information. This parameter is read-only. Latest review information about a business object, including the business details, reviewer information, and review time.  |
   +-----------------------+---------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | new_biz               | :ref:`BizVersionManageVO <showbizmetricbyid__response_bizversionmanagevo>` object           | Service version management. This parameter is read-only.                                                                                                                      |
   +-----------------------+---------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   ...
   |                       |                                                                                             | -  OFFLINE: offline                                                                                                                                                           |
   +-----------------------+---------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | self_defined_fields   | Array of :ref:`SelfDefinedFieldVO <showbizmetricbyid__response_selfdefinedfieldvo>` objects | Custom Fields                                                                                                                                                                 |
   +-----------------------+---------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+

.. _showbizmetricbyid__response_approvalvo:
...
.. _showbizmetricbyid__response_bizversionmanagevo:
...
.. _showbizmetricbyid__response_selfdefinedfieldvo:
...
This API is used to query service indicator details based on the service indicator ID.

.. code-block:: text

   GET https://{endpoint}/v2/{project_id}/design/biz-metrics/1231249989901135872
...
This operation is successful, and the returned data is BizMetricVO details.
...

   {
     "data" : {
       "value" : {
         ...
         "name" : "test_update_biz_metrics",
         "code" : "ZB000001",
         "name_alias" : "",
         "biz_type" : null,
         "status" : "DRAFT",
         "biz_catalog_id" : "1200479561188536320",
         "biz_catalog_path" : "aaa001",
         "create_by" : "test_uesr",
         "update_by" : "test_uesr",
         "data_origin" : "",
         "unit" : "",
         ...
         "approval_info" : null,
         "new_biz" : null,
         "create_time" : "2024-04-20T14:27:53+08:00",
         "update_time" : "2024-04-20T14:31:44+08:00",
         "l1" : "aaa001",
         "l2" : null,
         "l3" : null,
         "biz_metric" : null,
...
+=============+=============================================================================+
| 200         | This operation is successful, and the returned data is BizMetricVO details. |
+-------------+-----------------------------------------------------------------------------+
| 400         | BadRequest                                                                  |
+-------------+-----------------------------------------------------------------------------+
| 401         | Unauthorized                                                                |
