:original_name: ListBizMetricDimensions.html

.. _ListBizMetricDimensions:
...
View the indicator dimension information.
...
GET /v2/{project_id}/design/biz-metrics/dimensions
...
.. table:: **Table 4** Response body parameters
   ...
   +===========+=============================================================+================================================================+
   | data      | :ref:`data <listbizmetricdimensions__response_data>` object | data: unified outermost data structure of the returned result. |
   +-----------+-------------------------------------------------------------+----------------------------------------------------------------+

.. _listbizmetricdimensions__response_data:
...
.. table:: **Table 5** data
   ...
   | Parameter | Type             | Description                                                 |
   +===========+==================+=============================================================+
   | value     | Array of strings | value: unified outer data structure of the returned result. |
   +-----------+------------------+-------------------------------------------------------------+
...
.. code-block:: text
   ...
   GET https://{endpoint}/v2/{project_id}/design/biz-metrics/dimensions
...
This operation succeeds, and the returned data is a dimension name array.

.. code-block::

   {
     "data" : {
       "value" : [ "Rate Code", "Date dimension", "Payment Methods", "Suppliers" ]
     }
   }
...
+=============+===========================================================================+
| 200         | This operation succeeds, and the returned data is a dimension name array. |
+-------------+---------------------------------------------------------------------------+
| 400         | BadRequest                                                                |
+-------------+---------------------------------------------------------------------------+
| 401         | Unauthorized                                                              |
