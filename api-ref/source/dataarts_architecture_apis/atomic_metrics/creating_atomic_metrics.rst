:original_name: CreateDesignAtomicIndex.html

.. _CreateDesignAtomicIndex:
...
POST /v2/{project_id}/design/atomic-indexs
...
.. table:: **Table 3** Request body parameters
   ...
   +-----------------+-----------------+----------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | approval_info   | No              | :ref:`ApprovalVO <createdesignatomicindex__request_approvalvo>` object                 | Approval information. This parameter is read-only. Latest review information about a business object, including the business details, reviewer information, and review time. |
   +-----------------+-----------------+----------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | new_biz         | No              | :ref:`BizVersionManageVO <createdesignatomicindex__request_bizversionmanagevo>` object | Service version management. This parameter is read-only.                                                                                                                     |
   +-----------------+-----------------+----------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+

.. _createdesignatomicindex__request_approvalvo:
...
.. _createdesignatomicindex__request_bizversionmanagevo:
...
.. table:: **Table 6** Response body parameters
   ...
   +===========+=============================================================+================+
   | data      | :ref:`data <createdesignatomicindex__response_data>` object | Returned data. |
   +-----------+-------------------------------------------------------------+----------------+

.. _createdesignatomicindex__response_data:
...
.. table:: **Table 7** data
   ...
   | Parameter | Type                                                                          | Description                |
   +===========+===============================================================================+============================+
   | value     | :ref:`AtomicIndexVO <createdesignatomicindex__response_atomicindexvo>` object | Returned data information. |
   +-----------+-------------------------------------------------------------------------------+----------------------------+

.. _createdesignatomicindex__response_atomicindexvo:
...
.. table:: **Table 8** AtomicIndexVO
   ...
   +-----------------------+-----------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | approval_info         | :ref:`ApprovalVO <createdesignatomicindex__response_approvalvo>` object                 | Approval information. This parameter is read-only. Latest review information about a business object, including the business details, reviewer information, and review time.                                                      |
   +-----------------------+-----------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | new_biz               | :ref:`BizVersionManageVO <createdesignatomicindex__response_bizversionmanagevo>` object | Service version management. This parameter is read-only.                                                                                                                                                                          |
   +-----------------------+-----------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+

.. _createdesignatomicindex__response_approvalvo:
...
.. _createdesignatomicindex__response_bizversionmanagevo:
...
Create an atomic metric based on the following parameters:

.. code-block:: text

   POST https://{endpoint}/v2/{project_id}/design/atomic-indexs

   {
     "id" : 0,
     "name_ch" : "test_create_atomic_index",
     "name_en" : "test_create_atomic_index",
...

   {
     "data" : {
       "value" : {
         ...
         "status" : "DRAFT",
         "biz_type" : "FACT_LOGIC_TABLE",
         "create_time" : "2024-04-11T14:37:15.423+08:00",
         "update_time" : "2024-04-11T14:37:15.423+08:00",
         "l1" : null,
         "l2" : null,
         "l3" : null,
         "approval_info" : null,
