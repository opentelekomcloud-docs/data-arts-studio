:original_name: SearchAtomicIndexes.html

.. _SearchAtomicIndexes:
...
You can search for atomic metrics by Chinese and English names, creator, reviewer, status, and modification time. Fuzzy search is supported.
...
GET /v2/{project_id}/design/atomic-indexs
...
.. table:: **Table 4** Response body parameters
   ...
   +===========+=========================================================+================+
   | data      | :ref:`data <searchatomicindexes__response_data>` object | Returned data. |
   +-----------+---------------------------------------------------------+----------------+

.. _searchatomicindexes__response_data:
...
.. table:: **Table 5** data
   ...
   | Parameter | Type                                                      | Description                |
   +===========+===========================================================+============================+
   | value     | :ref:`value <searchatomicindexes__response_value>` object | Returned data information. |
   +-----------+-----------------------------------------------------------+----------------------------+

.. _searchatomicindexes__response_value:
...
.. table:: **Table 6** value
   ...
   | Parameter | Type                                                                                | Description          |
   +===========+=====================================================================================+======================+
   | records   | Array of :ref:`AtomicIndexVO <searchatomicindexes__response_atomicindexvo>` objects | AtomicIndexVO array. |
   +-----------+-------------------------------------------------------------------------------------+----------------------+
   | total     | Integer                                                                             | Total number.        |
   +-----------+-------------------------------------------------------------------------------------+----------------------+

.. _searchatomicindexes__response_atomicindexvo:

.. table:: **Table 7** AtomicIndexVO
   ...
   +-----------------------+-------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | approval_info         | :ref:`ApprovalVO <searchatomicindexes__response_approvalvo>` object                 | Approval information. This parameter is read-only. Latest review information about a business object, including the business details, reviewer information, and review time.                                                      |
   +-----------------------+-------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | new_biz               | :ref:`BizVersionManageVO <searchatomicindexes__response_bizversionmanagevo>` object | Service version management. This parameter is read-only.                                                                                                                                                                          |
   +-----------------------+-------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+

.. _searchatomicindexes__response_approvalvo:
...
.. _searchatomicindexes__response_bizversionmanagevo:
...
Query the first 10 atomic metrics whose names contain test_a.

.. code-block:: text

   GET https://{endpoint}/v2/{project_id}/design/atomic-indexs?offset=1&limit=10&name=test_a
...
This operation succeeds, and the returned data is an AtomicIndexVO array and the total number of records.
...

   {
     "data" : {
       "value" : {
         "total" : 1,
         "records" : [ {
           "id" : "1194663814218559488",
           "name_en" : "test_atomic",
           "name_ch" : "test_atomic",
           "description" : "",
           "create_by" : "test_uesr",
           "cal_exp" : "avg(${1184822297161261056}) ",
           "cal_fn_ids" : null,
           "l1_id" : "1080855591154495488",
           "l2_id" : null,
           "l3_id" : null,
           "table_id" : "1184822297001877504",
           "tb_name" : "test_111",
           "dw_type" : "DWS",
           "field_ids" : [ "1184822297161261056" ],
           "field_names" : null,
           "status" : "PUBLISHED",
           "biz_type" : "FACT_LOGIC_TABLE",
           "create_time" : "2024-01-10T15:27:29+08:00",
           "update_time" : "2024-01-10T15:29:30+08:00",
           "l1" : "ceshi_test_2",
           "l2" : null,
           "l3" : null,
           "approval_info" : {
             "id" : "1194664324778602496",
             "tenant_id" : null,
             "name_ch" : null,
             "name_en" : null,
             "biz_id" : "1194663814218559488",
             "biz_type" : null,
             "biz_info" : null,
             "biz_info_obj" : null,
             "biz_version" : 0,
             ...
             "approval_type" : null,
             "submit_time" : "2024-01-10T15:29:31+08:00",
             "create_by" : null,
             "l1" : null,
             "l2" : null,
             "l3" : null,
             "approval_time" : "2024-01-10T15:29:31+08:00",
             "approver" : "test_uesr",
             "email" : null,
             "msg" : "Fast Approval OK. (Associated Publish By test_atomic, Automatic Approval.)",
             "directory_path" : null
           },
           "new_biz" : null
         } ]
...
+=============+===========================================================================================================+
| 200         | This operation succeeds, and the returned data is an AtomicIndexVO array and the total number of records. |
+-------------+-----------------------------------------------------------------------------------------------------------+
| 400         | BadRequest                                                                                                |
+-------------+-----------------------------------------------------------------------------------------------------------+
| 401         | Unauthorized                                                                                              |
