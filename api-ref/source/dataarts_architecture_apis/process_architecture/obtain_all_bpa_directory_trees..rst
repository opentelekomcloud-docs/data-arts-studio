:original_name: ListCatalogTree.html
...
This API is used to obtain all directory trees.
...
GET /v2/{project_id}/design/biz/catalogs/tree
...
.. table:: **Table 3** Response body parameters
   ...
   +===========+=====================================================+================================================================+
   | data      | :ref:`data <listcatalogtree__response_data>` object | data: unified outermost data structure of the returned result. |
   +-----------+-----------------------------------------------------+----------------------------------------------------------------+

.. _listcatalogtree__response_data:
...
.. table:: **Table 4** data
   ...
   | Parameter | Type                                                                          | Description                                                 |
   +===========+===============================================================================+=============================================================+
   | value     | Array of :ref:`BizCatalogVO <listcatalogtree__response_bizcatalogvo>` objects | value: unified outer data structure of the returned result. |
   +-----------+-------------------------------------------------------------------------------+-------------------------------------------------------------+

.. _listcatalogtree__response_bizcatalogvo:
...
.. table:: **Table 5** BizCatalogVO
   ...
   +---------------+-------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | children      | Array of :ref:`BizCatalogVO <listcatalogtree__response_bizcatalogvo>` objects | Lower-level subdirectory, which is read-only.                                                                                                                                 |
   +---------------+-------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
.. code-block:: text
   ...
   PUT https://{endpoint}/v2/{project_id}/design/biz/catalogs/tree
...

   {
     "data" : {
       "value" : [ {
         "name" : "test_czh_02",
         "description" : null,
         "guid" : "cb46da58-2430-4148-ae3f-0c526143ab07",
         "owner" : "{\"owners\":[\"test_uesr\"]}",
         "parent_id" : null,
         "prev_id" : "1193123592125169667",
         "next_id" : "1200475693864079360",
         "id" : "1193123592129363971",
         "qualified_id" : "1193123592129363971",
         "create_by" : "test_uesr",
         "update_by" : "test_uesr",
         "create_time" : "2024-01-06T09:27:12+08:00",
         "update_time" : "2024-01-06T10:41:20+08:00",
         "bizmetric_num" : null,
         "children_num" : null,
         "children" : null
       } ]
