:original_name: DeleteCatalog.html
...
DELETE /v2/{project_id}/design/biz/catalogs
...
.. table:: **Table 4** Response body parameters
   ...
   +===========+===================================================+====================================================================================================+
   | data      | :ref:`data <deletecatalog__response_data>` object | Indicates the final deletion result, that is, the number of objects that are successfully deleted. |
   +-----------+---------------------------------------------------+----------------------------------------------------------------------------------------------------+

.. _deletecatalog__response_data:
...
This API deletes a process architecture based on the input parameters.

.. code-block:: text

   DELETE https://{endpoint}/v2/{project_id}/design/biz/catalogs

   {
     "ids" : [ "1193132546607693824" ]
   }
