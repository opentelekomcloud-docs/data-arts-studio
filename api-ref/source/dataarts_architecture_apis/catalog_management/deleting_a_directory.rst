:original_name: DeleteDirectory.html
...
Delete directories (data standards and code tables).
...
DELETE /v2/{project_id}/design/directorys
...
.. table:: **Table 4** Response body parameters
   ...
   +===========+=====================================================+====================================================================================================+
   | data      | :ref:`data <deletedirectory__response_data>` object | Indicates the final deletion result, that is, the number of objects that are successfully deleted. |
   +-----------+-----------------------------------------------------+----------------------------------------------------------------------------------------------------+

.. _deletedirectory__response_data:
...
Modify the directory based on the request parameters.

.. code-block:: text

   DELETE https://{endpoint}/v2/{project_id}/design/directorys?ids=1231215227505364992
