:original_name: DeleteDesignDimensionLogicTable.html

.. _DeleteDesignDimensionLogicTable:
...
This API is used to delete dimension tables with specified IDs.
...
DELETE /v2/{project_id}/design/dimension-logic-tables
...
.. table:: **Table 4** Response body parameters
   ...
   +===========+=====================================================================+====================================================================================================+
   | data      | :ref:`data <deletedesigndimensionlogictable__response_data>` object | Indicates the final deletion result, that is, the number of objects that are successfully deleted. |
   +-----------+---------------------------------------------------------------------+----------------------------------------------------------------------------------------------------+

.. _deletedesigndimensionlogictable__response_data:
...
Delete dimension tables based on the input parameters. Only dimension tables in the draft, offline, or rejected state can be deleted.
