:original_name: ShowRelationById.html
...
This API is used to obtain relationship details by ID.
...
.. table:: **Table 4** Response body parameters
   ...
   +===========+======================================================+================================================================+
   | data      | :ref:`data <showrelationbyid__response_data>` object | data: unified outermost data structure of the returned result. |
   +-----------+------------------------------------------------------+----------------------------------------------------------------+

.. _showrelationbyid__response_data:
...
.. table:: **Table 5** data
   ...
   | Parameter | Type                                                             | Description                                                 |
   +===========+==================================================================+=============================================================+
   | value     | :ref:`RelationVO <showrelationbyid__response_relationvo>` object | value: unified outer data structure of the returned result. |
   +-----------+------------------------------------------------------------------+-------------------------------------------------------------+

.. _showrelationbyid__response_relationvo:

.. table:: **Table 6** RelationVO
   ...
   +-----------------------+------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | mappings              | Array of :ref:`RelationMappingVO <showrelationbyid__response_relationmappingvo>` objects | Table attribute information, which is read-only.                                                                                                                              |
   +-----------------------+------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+

.. _showrelationbyid__response_relationmappingvo:

.. table:: **Table 7** RelationMappingVO
...
This API queries relationship details by ID to obtain the relationship list.

.. code-block:: text

   GET https://{endpoint}/v2/{project_id}/design/relation/1225137038202957824
...
This operation is successful, and the returned data is RelationVO details.
...
+=============+============================================================================+
| 200         | This operation is successful, and the returned data is RelationVO details. |
+-------------+----------------------------------------------------------------------------+
| 400         | BadRequest                                                                 |
+-------------+----------------------------------------------------------------------------+
| 401         | Unauthorized                                                               |
