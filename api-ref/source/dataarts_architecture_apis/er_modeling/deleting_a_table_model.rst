:original_name: DeleteTableModel.html
...
Deletes a table model and its attributes, including logical entities and physical tables, from relational modeling.
...
DELETE /v2/{project_id}/design/table-model
...
.. table:: **Table 4** Response body parameters
   ...
   +===========+======================================================+====================================================================================================+
   | data      | :ref:`data <deletetablemodel__response_data>` object | Indicates the final deletion result, that is, the number of objects that are successfully deleted. |
   +-----------+------------------------------------------------------+----------------------------------------------------------------------------------------------------+

.. _deletetablemodel__response_data:
...
Delete the physical table based on the request parameters.

.. code-block:: text

   DELETE https://{endpoint}/v2/{project_id}/design/table-model

   {
     "ids" : [ "1231921671028518912" ],
