:original_name: BatchPublish.html
...
.. table:: **Table 3** Request body parameters
   ...
   | Parameter          | Mandatory       | Type                                                                | Description                                                                                                                                                       |
   +====================+=================+=====================================================================+===================================================================================================================================================================+
   | biz_infos          | Yes             | Array of :ref:`BizInfoVO <batchpublish__request_bizinfovo>` objects | Service information list.                                                                                                                                         |
   +--------------------+-----------------+---------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
.. _batchpublish__request_bizinfovo:
...
.. table:: **Table 5** Response body parameters
   ...
   +===========+==================================================+=============================================+
   | data      | :ref:`data <batchpublish__response_data>` object | Number of successful batch release results. |
   +-----------+--------------------------------------------------+---------------------------------------------+

.. _batchpublish__response_data:
...
.. table:: **Table 6** data
   ...
   | Parameter | Type                                                                     | Description           |
   +===========+==========================================================================+=======================+
   | value     | :ref:`BatchOperationVO <batchpublish__response_batchoperationvo>` object | Batch release result. |
   +-----------+--------------------------------------------------------------------------+-----------------------+

.. _batchpublish__response_batchoperationvo:
...
.. table:: **Table 7** BatchOperationVO
   ...
   | logs                  | String                                                                             | Logs.                                                                                                            |
   +-----------------------+------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------+
   | groups                | Array of :ref:`BatchOperationVO <batchpublish__response_batchoperationvo>` objects | Group information.                                                                                               |
   +-----------------------+------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------+
...
.. code-block:: text
   ...
   POST https://{endpoint}/v2/{project_id}/design/approvals/batch-publish?from=standard
