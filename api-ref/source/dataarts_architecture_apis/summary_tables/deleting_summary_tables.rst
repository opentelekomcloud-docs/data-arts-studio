:original_name: DeleteDesignAggregationLogicTable.html

.. _DeleteDesignAggregationLogicTable:
...
You can delete summary tables in batches. Only tables in the Draft, Offline, or Rejected state can be deleted.
...
DELETE /v2/{project_id}/design/aggregation-logic-tables
...
.. table:: **Table 4** Response body parameters
   ...
   +===========+=======================================================================+====================================================================================================+
   | data      | :ref:`data <deletedesignaggregationlogictable__response_data>` object | Indicates the final deletion result, that is, the number of objects that are successfully deleted. |
   +-----------+-----------------------------------------------------------------------+----------------------------------------------------------------------------------------------------+

.. _deletedesignaggregationlogictable__response_data:
...
This API is used to delete a summary table based on the input parameter.

.. code-block:: text

   DELETE https://{endpoint}/v2/{project_id}/design/aggregation-logic-tables

   {
     "ids" : [ "1227937502401331200" ],
...
This operation succeeds, and the returned data is the number of deleted data records.
