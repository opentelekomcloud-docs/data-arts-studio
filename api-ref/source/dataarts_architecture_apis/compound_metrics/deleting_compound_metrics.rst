:original_name: DeleteDesignCompoundMetric.html

.. _DeleteDesignCompoundMetric:
...
This API is used to delete compound metrics with specified IDs.
...
DELETE /v2/{project_id}/design/compound-metrics
...
.. table:: **Table 4** Response body parameters
   ...
   +===========+================================================================+====================================================================================================+
   | data      | :ref:`data <deletedesigncompoundmetric__response_data>` object | Indicates the final deletion result, that is, the number of objects that are successfully deleted. |
   +-----------+----------------------------------------------------------------+----------------------------------------------------------------------------------------------------+

.. _deletedesigncompoundmetric__response_data:
...
Delete compound metrics based on the input parameters. Only compound metrics in the draft, offline, or rejected state can be deleted.

.. code-block:: text

   DELETE https://{endpoint}/v2/{project_id}/design/compound-metrics
...
The operation succeeds, and the number of deleted compound metrics is returned.
...
+=============+=================================================================================+
| 200         | The operation succeeds, and the number of deleted compound metrics is returned. |
+-------------+---------------------------------------------------------------------------------+
| 400         | BadRequest                                                                      |
+-------------+---------------------------------------------------------------------------------+
| 401         | Unauthorized                                                                    |
