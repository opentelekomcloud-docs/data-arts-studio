:original_name: UpdateDataconnection.html

.. _UpdateDataconnection:
...
PUT /v1/{project_id}/data-connections/{data_connection_id}
...
.. table:: **Table 3** Request body parameters
   ...
   | Parameter       | Mandatory | Type                                                                                      | Description           |
   +=================+===========+===========================================================================================+=======================+
   | data_source_vos | No        | Array of :ref:`ApigDataSourceVo <updatedataconnection__request_apigdatasourcevo>` objects | Data source structure |
   +-----------------+-----------+-------------------------------------------------------------------------------------------+-----------------------+

.. _updatedataconnection__request_apigdatasourcevo:
...
The data connection information is updated.
...
=========== ===========================================
200         The data connection information is updated.
400         Bad request.
