:original_name: UpdateWorkSpaceUserOrGroup.html

.. _UpdateWorkSpaceUserOrGroup:
...
.. table:: **Table 1** Path Parameters
   ...
   +--------------+-----------+--------+---------------------------------------------------------------------------------------------------------------------+
   | user_id      | Yes       | String | User ID, which can be obtained from the user information on IAM                                                     |
   +--------------+-----------+--------+---------------------------------------------------------------------------------------------------------------------+
...
.. table:: **Table 3** Request body parameters
   ...
   +-----------+-----------+---------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------+
   | user_ids  | No        | Array of :ref:`ApigIamUserDto <updateworkspaceuserorgroup__request_apigiamuserdto>` objects | User list, which can be obtained using the API for querying the workspace user information list           |
   +-----------+-----------+---------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------+
   | groups    | No        | Array of :ref:`Group <updateworkspaceuserorgroup__request_group>` objects                   | User group list, which can be obtained using the API for querying the workspace user information list     |
   +-----------+-----------+---------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------+
   | roles_ids | Yes       | Array of :ref:`ApigRole <updateworkspaceuserorgroup__request_apigrole>` objects             | Workspace role list, which can be obtained using the API for querying the workspace user information list |
   +-----------+-----------+---------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------+

.. _updateworkspaceuserorgroup__request_apigiamuserdto:
...
.. _updateworkspaceuserorgroup__request_group:
...
.. _updateworkspaceuserorgroup__request_apigrole:
...
The workspace user is modified.
...
=========== ===============================
200         The workspace user is modified.
400         Bad request.
