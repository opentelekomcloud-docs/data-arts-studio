:original_name: ShowApiDashboard.html
...
This API is used to query details about a specified API dashboard.
...
.. table:: **Table 4** Response body parameters
   ...
   +============+==================================================================================================+=======================+
   | dashboards | Array of :ref:`StatisticForDashboard <showapidashboard__response_statisticfordashboard>` objects | Statistics dashboard. |
   +------------+--------------------------------------------------------------------------------------------------+-----------------------+

.. _showapidashboard__response_statisticfordashboard:
...
Query details about a specified API dashboard.

.. code-block::

   /v1/0833a5737480d53b2f250010d01a7b88/service/statistic/apis-dashboards/760715eb1bfce0c575abab3be3bd41e6
...
The data details of the specified API dashboard are queried successfully.
...
+=============+===========================================================================+
| 200         | The data details of the specified API dashboard are queried successfully. |
+-------------+---------------------------------------------------------------------------+
| 400         | Bad request                                                               |
+-------------+---------------------------------------------------------------------------+
