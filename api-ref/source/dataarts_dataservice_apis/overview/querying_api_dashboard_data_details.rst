:original_name: ShowApisDashboard.html
...
GET /v1/{project_id}/service/statistic/apis-dashboards
...
.. table:: **Table 4** Response body parameters
   ...
   +============+===================================================================================================+=======================+
   | dashboards | Array of :ref:`StatisticForDashboard <showapisdashboard__response_statisticfordashboard>` objects | Statistics dashboard. |
   +------------+---------------------------------------------------------------------------------------------------+-----------------------+

.. _showapisdashboard__response_statisticfordashboard:
...
Query API dashboard data details.

.. code-block::

   /v1/0833a5737480d53b2f250010d01a7b88/service/statistic/apis-dashboards
...
API dashboard data details are queried successfully.
...
=========== ====================================================
200         API dashboard data details are queried successfully.
400         Bad request
=========== ====================================================
