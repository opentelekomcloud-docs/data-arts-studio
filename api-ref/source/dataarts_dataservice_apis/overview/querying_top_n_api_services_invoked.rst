:original_name: ListApisTop.html
...
This API is used to query the top N API services invoked.
...
.. table:: **Table 4** Response body parameters
   ...
   +============+=======================================================================================+==========================+
   | statistics | Array of :ref:`StatisticForDetail <listapistop__response_statisticfordetail>` objects | Statistics details list. |
   +------------+---------------------------------------------------------------------------------------+--------------------------+

.. _listapistop__response_statisticfordetail:
...
Query the top N API services invoked.

.. code-block::

   /v1/0833a5737480d53b2f250010d01a7b88/service/statistic/apis-top-n
...
The top N API services are successfully queried.
...
=========== ================================================
200         The top N API services are successfully queried.
400         Bad request
=========== ================================================
