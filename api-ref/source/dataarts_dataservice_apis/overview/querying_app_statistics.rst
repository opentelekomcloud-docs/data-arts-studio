:original_name: ShowAppsDetail.html
...
This API is used to query the statistics of an app.
...
GET /v1/{project_id}/service/statistic/apps-detail/{app_id}
...
Query the statistics of an app.

.. code-block::

   /v1/0833a5737480d53b2f250010d01a7b88/service/statistic/apps-detail/760715eb1bfce0c575abab3be3bd41e6
...
App statistics details are queried successfully.
...
=========== ================================================
200         App statistics details are queried successfully.
400         Bad request
=========== ================================================
