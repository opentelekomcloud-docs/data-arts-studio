:original_name: ListAppsTop.html
...
This API is used to query top N services used by an app.
...
GET /v1/{project_id}/service/statistic/apps-top-n
...
.. table:: **Table 4** Response body parameters
   ...
   +============+=======================================================================================+==========================+
   | statistics | Array of :ref:`StatisticForDetail <listappstop__response_statisticfordetail>` objects | Statistics details list. |
   +------------+---------------------------------------------------------------------------------------+--------------------------+

.. _listappstop__response_statisticfordetail:

.. table:: **Table 5** StatisticForDetail
...
Query top N services used by an app.

.. code-block::

   /v1/0833a5737480d53b2f250010d01a7b88/service/statistic/apps-top-n
...
Top N app services are queried successfully.
...
=========== ============================================
200         Top N app services are queried successfully.
400         Bad request
=========== ============================================
