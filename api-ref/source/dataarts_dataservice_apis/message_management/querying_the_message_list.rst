:original_name: ListMessage.html
...
.. table:: **Table 4** Response body parameters
   ...
   +-----------+-------------------------------------------------------------------------------------------+-------------------------------------------------------------+
   | records   | Array of :ref:`RecordForApplyDetail <listmessage__response_recordforapplydetail>` objects | Indicates the returned application list.                    |
   +-----------+-------------------------------------------------------------------------------------------+-------------------------------------------------------------+

.. _listmessage__response_recordforapplydetail:
...
+=============+========================================================================================================+
| 200         | The query is successful, and the total number of messages that meet the query conditions is displayed. |
+-------------+--------------------------------------------------------------------------------------------------------+
| 400         | Bad request                                                                                            |
+-------------+--------------------------------------------------------------------------------------------------------+
