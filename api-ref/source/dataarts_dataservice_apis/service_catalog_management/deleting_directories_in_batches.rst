:original_name: DeleteServiceCatalog.html

.. _DeleteServiceCatalog:
...
This API is used to delete service catalogs in batches.
...
.. table:: **Table 3** Request body parameters
   ...
   Parameter Mandatory Type             Description
   ========= ========= ================ ===========
   ids       No        Array of strings Catalog ID
   ========= ========= ================ ===========
...
.. code-block::
   ...
   /v1/0833a5737480d53b2f250010d01a7b88/service/servicecatalogs/batch-delete

   {
     "ids" : [ "a8523d5a41e7c6c1b38c2bc0984f097e" ]
   }
