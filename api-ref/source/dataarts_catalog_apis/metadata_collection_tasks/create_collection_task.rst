...
.. table:: **Table 3** Request body parameters
   ...
   +--------------------------+-----------+-----------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------+
   | schedule_config          | Yes       | :ref:`SchedulerInfo <createtask__request_schedulerinfo>` object             | Scheduling information                                                                                          |
   +--------------------------+-----------+-----------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------+
   | parameter_config         | No        | Array of :ref:`CustomMetadata <createtask__request_custommetadata>` objects | User-defined metadata information.                                                                              |
   +--------------------------+-----------+-----------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------+
...
.. _createtask__request_schedulerinfo:
...
.. _createtask__request_custommetadata:
