:original_name: AssociateSecurityLevelToEntitie.html

.. _AssociateSecurityLevelToEntitie:
...
Associate the asset with the security level. The asset is associated with the specified security level.
...
PUT /v3/{project_id}/asset/entities/guid/{guid}/security-level
...
.. table:: **Table 2** Query Parameters
   ...
   Parameter      Mandatory Type   Description
   ============== ========= ====== =====================
   security-level Yes       String Asset security level.
   ============== ========= ====== =====================
