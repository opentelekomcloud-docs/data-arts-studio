...
By creating an OBS link, you can extract files from or load files to Object Storage Service (OBS). Files in CSV, JSON, and binary format are supported.
...
+--------------------------+-----------------+-----------------+---------------------------------------------------------------------------------------------------------------------------------------------------+
| linkConfig.obsBucketType | No              | String          | OBS bucket type                                                                                                                                   |
|                          |                 |                 |                                                                                                                                                   |
|                          |                 |                 | -  **OB**: object bucket                                                                                                                          |
...
|                          |                 |                 | .. note::                                                                                                                                         |
|                          |                 |                 |                                                                                                                                                   |
|                          |                 |                 |    A parallel file system is recommended because filtering files in an object bucket is slow.                                                     |
+--------------------------+-----------------+-----------------+---------------------------------------------------------------------------------------------------------------------------------------------------+
