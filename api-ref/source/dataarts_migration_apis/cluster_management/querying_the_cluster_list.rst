...
.. table:: **Table 7** ClusterDetailInstance
   ...
   | group                 | String                                                                     | Group                                                                                   |
   +-----------------------+----------------------------------------------------------------------------+-----------------------------------------------------------------------------------------+
   | links                 | Array of :ref:`ClusterLinks <listclusters__response_clusterlinks>` objects | Links (null is returned for querying the cluster list)                                  |
   +-----------------------+----------------------------------------------------------------------------+-----------------------------------------------------------------------------------------+
...
.. table:: **Table 8** flavor
   ...
   +-----------+----------------------------------------------------------------------------+--------------+
   | links     | Array of :ref:`ClusterLinks <listclusters__response_clusterlinks>` objects | Links        |
   +-----------+----------------------------------------------------------------------------+--------------+
